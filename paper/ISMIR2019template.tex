...
As opposed to Isophonics and RWC, these two sets contain highly diverse music in terms of genre: from world-music to rock, including jazz, blues, and even live music.
...
The annotations and some of the song-level metadata are distributed via 715 JAMS~\cite{Humphrey2014} files, one per track.
