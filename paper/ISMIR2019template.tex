...
\begin{figure}
    ...
    \caption{Tempo standard deviation of the \setName~set.}
    \label{fig:BPM_std}
\end{figure}

In terms of segment statistics, we show several heuristics based on those described in a MIREX meta-analysis of the segmentation task~\cite{Smith2013}.

\begin{figure}
    \centerline{\includegraphics[width=\columnwidth]{figs/segment_label_count.pdf}}
    \caption{Number of segments per track, based on their labels.}
