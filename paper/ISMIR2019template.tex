...
This set contains mostly western popular music, with strong emphasis on Pop, EDM, and Rock.
...
We discussed a set of results using current algorithms in the literature in terms of beat tracking, downbeat prediction, and structural segmentation to give an initial benchmark of the set.
