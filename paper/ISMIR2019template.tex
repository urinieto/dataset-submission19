...
madmom~\cite{Bock2016b}\footnote{We used madmom 0.16.1.} or librosa python libraries. By running these algorithms in other datasets with the same metrics, a comparison of datasets could ultimately be performed. The results are also provided with the dataset in CSV format. This is intendended
