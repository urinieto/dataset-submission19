...
The \setName~set contains manual annotations for 715 western popular music tracks, thus being the largest to date published dataset containing beats, downbeats, and functional structural segmentation information.
...
We presented the \setName~set, the largest dataset in terms of human annotations containing the following three types of information: beats, downbeats, and function structural segments.
